...
Docker 的核心理念是 **一次构建，到处运行**。理解了镜像分层、构建缓存、多阶段构建，你就能写出高效的生产级 Dockerfile。`
  },
  {
    ...
    date: '2026-07-11',
    tags: ['未分类'],
    excerpt: '杨智，出身中医世家，祖辈四代从医，硕士研究生。执业中医师、副主任中医师，擅长骨科、内科、妇科及肿瘤辅助治疗，精于中药、针灸、刃针、整脊等疗法。',
    content: `# 杨智 | 个人简介

> 出身中医世家，祖辈四代从医。执业中医师、副主任中医师，专注于中西医结合临床。

## 教育与实践背景

杨智，出身于中医世家，祖辈四代从医。毕业于**陕西中医药大学**，硕士研究生。曾先后于辽宁中医学院附属医院、陕西中医学院附属医院实践深造，并拜师于岐轩医学体系挖掘人**张润杰**先生，系统研习岐轩脉法、养生、易经、内观、岐轩药功推拿及一元针法等学术精华。

期间亦跟随**石学敏院士**、**马居里教授**、**王志易教授**等多位名家学习，积累了丰富的临床经验。
...
### 内科
咳嗽、哮喘、心脏病、高血压、糖尿病、肾脏疾病、胃炎、胃溃疡，小儿免疫力低下及消化不良，部分疑难杂症。对**糖尿病早期、高血压早期**有较丰富的临床调理经验。

### 妇科
月经不调、崩漏带下、不孕不育、围绝经期综合征。

### 肿瘤辅助治疗
擅长运用中医药辅助化疗、放疗，以中医药及中西医结合方法参与中晚期乳腺癌、肺癌、食管癌、胃癌、结直肠癌、卵巢癌、宫颈癌等恶性肿瘤的综合治疗。
